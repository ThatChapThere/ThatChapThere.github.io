...
var genera = { //genera database
	...
	'Agrosaurus' : new Genus(205.6, 201.6, 1891, 3, [], 'Thecodontosaurus', ['England'], 'Seeley', true, 'Possibly, but not likely, Austalian.'),
	...
	'Almas' : new Genus(75, 71, 2017, 0.8, [], ''),
	'Alnashetri' : new Genus(99, 94, 2012, 0.8, [], ''),
	'Alocodon' : new Genus(145, 157, 1975, 2, [], ''),
	'Altirhinus' : new Genus(120, 112, 1998, 8, [], ''),
	'Altispinax' : new Genus(140, 133, 1923, 8, ['Becklespinax'], ''),
	'Alvarezsaurus' : new Genus(86, 84, 1991, 1.4, [], ''),
	'Alwalkeria' : new Genus(235, 228, 1987, 0.5, [], ''),
	'Alxasaurus' : new Genus(125, 112, 1993, 3.8, [], ''),
	'Amargasaurus' : new Genus(130, 120, 1991, 12, [], ''),
	'Amargastegos' : new Genus(125, 125, 2014, 5, [], ''),
	'Amargatitanis' : new Genus(130, 120, 2007, 20, [], ''),
	'Amazonsaurus' : new Genus(125, 100, 2003, 12, [], ''),
	'Ampelosaurus' : new Genus(71, 66, 1995, 15, [], ''),
	'Amphicoelias' : new Genus(71, 66, 1878, 58, [], ''),
	'Amtocephale' : new Genus(98, 83, 2011, 2.5, [], ''),
	'Amtosaurus' : new Genus(100, 83, 1978, 5, [], 'Talarurus'),
	'Amurosaurus' : new Genus(68, 66, 1991, 8, [], ''),
} 
	...
	'@Dinosauria' : '@Dinosauria',
		...
		'@Ornithoscelida' : '@Dinosauria',
							...
							'@Eurypoda' : '@Thyreophora',
								...
								'@Ankylosauria' : '@Eurypoda',
									...
									'@Ankylosauridae' : '@Ankylosauria',
										'#Aletopelta1' : '@Ankylosauridae',
											'Aletopelta' : '#Aletopelta1',
												'coombsi' : 'Aletopelta',
											'@Ankylosaurinae' : '#Aletopelta1',
												'Ahshislepelta' : '@Ankylosaurinae',
													'minor' : 'Ahshislepelta',
						'@Neornithischia' : '@Genasauria',
							'Alocodon' : '@Neornithischia',
								'kuehnei' : 'Alocodon',
			...
			'@Theropoda' : '@Ornithoscelida',
				'#Eoraptor1' : '@Theropoda',
					'#Eoraptor2' : '#Eoraptor1',
						'Alwalkeria' : '#Eoraptor2',
							'maleriensis' : 'Alwalkeria',
					'@Neotheropda' : '#Eoraptor1',
