...
var genusImageURLs = {
	...
	'Alwalkeria' : 'images/Alwalkeria.jpg',
	'Andhrasaurus' : 'images/andhrasaurus.jpg',
	'Anomalipes' : 'images/Anomalipes.jpg',
	'Antetonitrus' : 'images/Antetonitrus.jpg',
	'Asylosaurus' : 'images/Asylosaurus.jpg',
	'Bagualosaurus' : 'images/Bagualosaurus.jpg',
	...
	'Carcharodontosaurus' : 'images/Carcharodontosaurus.jpg',
	'Deinonychus' : 'images/Deinonychus.jpg',
	'Jeholornis' : 'images/Jeholornis.jpg',
	'Tornieria' : 'images/Tornieria.jpg',
	'Tyrannosaurus' : 'images/Tyrannosaurus.jpg',
	'Veterupristisaurus' : 'images/Veterupristisaurus.jpg',
}
/*/
var genusImageURLs = {
	...
	'Alwalkeria' : 'https://imgur.com/Sm8J7P5.jpg',
	'Andhrasaurus' : 'https://imgur.com/Vh6cbis.jpg',
	'Anomalipes' : 'https://imgur.com/4bVLLYl.jpg',
	'Antetonitrus' : 'https://imgur.com/6LHpB8C.jpg',
	'Asylosaurus' : 'https://imgur.com/OhjcTHJ.jpg',
	'Bagualosaurus' : 'https://imgur.com/iZ6cTu3',
...
var genera = { //genera database
	...
	'Alwalkeria' :              new Genus(235,   228,   1987, 0.5,  [], '', ['India'],        'Chatterjee & Creisler',  false, '', new Copyright('ElCaballero08', 'https://www.deviantart.com/elcaballero08/', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
	...
	'Antetonitrus' :            new Genus(220,   209,   2003, 10,   [], '', ['South Africa'], 'Yates & Kitching',       false, '', new Copyright('ElCaballero08', 'https://www.deviantart.com/elcaballero08/', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
	...
	'Asylosaurus' :             new Genus(209,   201,   1936, 2,    [], '', ['England'],      'Galton',                 false, '', new Copyright('ElCaballero08', 'https://www.deviantart.com/elcaballero08/', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
	...
	'Bagualosaurus' : new Genus(0   , 0    , 0    , 0 ,   [], '', [''],             '',                       false, '', new Copyright('ElCaballero08', 'https://www.deviantart.com/elcaballero08/', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
	...
	'Carcharodontosaurus' : new Genus(0   , 0    , 0    , 0 ,   [], '', [''],             '',                       false, '', new Copyright('TheDubstepAddict', 'https://www.deviantart.com/thedubstepaddict', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
	...
	'Crittendenceratops' : new Genus(0   , 0    , 0    , 0 ,   [], '', [''],             '',                       false, ''),
	...
	'Deinonychus' : new Genus(0   , 0    , 0    , 0 ,   [], '', [''],             '',                       false, '', new Copyright('TheDubstepAddict', 'https://www.deviantart.com/thedubstepaddict', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
	...
	'Jeholornis' : new Genus(0   , 0    , 0    , 0 ,   [], '', [''],             '',                       false, '', new Copyright('TheDubstepAddict', 'https://www.deviantart.com/thedubstepaddict', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
	...
	'Tornieria' : new Genus(0   , 0    , 0    , 0 ,   [], '', [''],             '',                       false, '', new Copyright('TheDubstepAddict', 'https://www.deviantart.com/thedubstepaddict', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
	...
	'Tyrannosaurus' : new Genus(0   , 0    , 0    , 0 ,   [], '', [''],             '',                       false, '', new Copyright('TheDubstepAddict', 'https://www.deviantart.com/thedubstepaddict', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
	...
	'Veterupristisaurus' : new Genus(0   , 0    , 0    , 0 ,   [], '', [''],             '',                       false, '', new Copyright('TheDubstepAddict', 'https://www.deviantart.com/thedubstepaddict', 'Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)', 'https://creativecommons.org/licenses/by-sa/4.0/')),
		...
		'@Saurischia' : '@Dinosauria',
			...
			'@Sauropodomorpha' : '@Saurischia',
				...
				'#Guaibasauridae1' : '@Sauropodomorpha',
					...
					'#Saturnaliinae1' : '#Guaibasauridae1',
						'@Saturnaliinae' : '#Saturnaliinae1',
							'Saturnalia' : '@Saturnaliinae',
							'Chromogisaurus' : '@Saturnaliinae',
						'#Pantydraco1' : '#Saturnaliinae1',
							'Pantydraco' : '#Pantydraco1',
							'#Thecodontosauridae1' : '#Pantydraco1',
								'@Thecodontosauridae' : '#Thecodontosauridae1',
									...
									'Thecodontosaurus' : '@Thecodontosauridae',
								'#Efraasia1' : '#Thecodontosauridae1',
									'#Efraasia2' : '#Efraasia1',
										'Efraasia' : '#Efraasia2',
										'Arcusaurus' : '#Efraasia2',
											'pereirabdalorum' : 'Arcusaurus',
									'#Plateosauravus1' : '#Efraasia1',
										'Plateosauravus' : '#Plateosauravus1',
										'@Plateosauria' : '#Plateosauravus1',
											'Ruehleia' : '@Plateosauria',
											'@Plateosauridae' : '@Plateosauria',
												'Unaysaurus' : '@Plateosauridae',
												'Plateosaurus' : '@Plateosauridae',
											'@Massopoda' : '@Plateosauria',
												'@Riojasauridae' : '@Massopoda',
													'Eucnemesaurus' : '@Riojasauridae',
													'Riojasaurus' : '@Riojasauridae',
														'incertus' : 'Riojasaurus',
												'#Sarahsaurus1' : '@Massopoda',
													'Sarahsaurus' : '#Sarahsaurus1',
													'#Massospondylidae1' : '#Sarahsaurus1',
														'@Massospondylidae' : '#Massospondylidae1',
															'#Lufengosaurus1' : '@Massospondylidae',
																'Lufengosaurus' : '#Lufengosaurus1',
																'Glacialisaurus' : '#Lufengosaurus1',
																'Coloradisaurus' : '#Lufengosaurus1',
															'#Massospondylus1' : '@Massospondylidae',
																'Massospondylus' : '#Massospondylus1',
																'#Adeopapposaurus1' : '#Massospondylus1',
																	'Adeopapposaurus' : '#Adeopapposaurus1',
																		'mognai' : 'Adeopapposaurus',
																	'Leyesaurus' : '#Adeopapposaurus1',
														'#Jingshanosaurus1' : '#Massospondylidae1',
															'Jingshanosaurus' : '#Jingshanosaurus1',
															'#Yunnanosaurus1' : '#Jingshanosaurus1',
																'Yunnanosaurus' : '#Yunnanosaurus1',
																'#Seitaad1' : '#Yunnanosaurus1',
																	'Seitaad' : '#Seitaad1',
																	'@Anchisauria' : '#Seitaad1',
																		'Anchisaurus' : '@Anchisauria',
																			 'polyzelus' : 'Anchisaurus',
																		'@Sauropodiformes' : '@Anchisauria',
																			'Mussaurus' : '@Sauropodiformes',
																			'#Aardonyx1' : '@Sauropodiformes',
																				'Leonerasaurus' : '#Aardonyx1',
																				'Sefapanosaurus' : '#Aardonyx1',
																				'Aardonyx' : '#Aardonyx1',
																					'celestae' : 'Aardonyx',
																				'#Melanorosaurus1' : '#Aardonyx1',
																					'Melanorosaurus' : '#Melanorosaurus1',
																					'@Sauropoda' : '#Melanorosaurus1',
																						'-Sauropoda' : '@Sauropoda',	
																																...
																																'#Diplodocoidea1' : '@Neosauropoda',
																																	...
																																	'@Macronaria' : '#Diplodocoidea1',
																																		'-Macronaria' : '@Macronaria',
																																			'Daanosaurus' : '-Macronaria',
																																			'Dongbeititan' : '-Macronaria',
																																			'Haestasaurus' : '-Macronaria',
																																		'#Camarasauridae1' : '@Macronaria',
																																			'@Camarasauridae' : '#Camarasauridae1',
																																				'Camarasaurus' : '@Camarasauridae',
																																				'Abrosaurus' : '@Camarasauridae',
																																					'dongpoi' : 'Abrosaurus',
																																			'#Galvesaurus2' : '#Camarasauridae1',
																																				'#Galvesaurus1' : '#Galvesaurus2',
																																					'Galvesaurus' : '#Galvesaurus1',
																																					'Tehuelchesaurus' : '#Galvesaurus1',
																																				'#Janenschia2' : '#Galvesaurus2',
																																					'#Janenschia1' : '#Janenschia2',
																																						'Janenschia' : '#Janenschia1',
																																						'Tastavinsaurus' : '#Janenschia1',
																																					'#Euhelopus' : '#Janenschia2',
																																						'Euhelopus' : '#Euhelopus',
																																						'#Chubutisaurus2' : '#Euhelopus',
																																							'#Chubutisaurus1' : '#Chubutisaurus2',
																																								'Chubutisaurus' : '#Chubutisaurus1',
																																								'Wintonotitan' : '#Chubutisaurus1',
																																							'@Titanosauriformes' : '#Chubutisaurus2',
																												...
																												'#Chasmosaurinae1' : '@Ceratopsidae',
																													'@Centrosaurinae' : '#Chasmosaurinae1',
																														'@Nasutoceratopsini' : '@Centrosaurinae',
																															'#Yehuecauhceratops2' : '@Nasutoceratopsini',
																																'#Yehuecauhceratops1' : '#Yehuecauhceratops2',
																																	'Yehuecauhceratops' : '#Yehuecauhceratops1',
																																	'Nasutoceratops' : '#Yehuecauhceratops1',
																																'Avaceratops' : '#Yehuecauhceratops2',
																															'Crittendenceratops' : '@Nasutoceratopsini',
																														'#Medusaceraops2' : '@Centrosaurinae',
																															'Albertaceratops' : '#Medusaceraops2',
																															'#Medusaceraops1' : '#Medusaceraops2',
																																'Medusaceraops' : '#Medusaceraops1',
																																'#Xenoceratops6' : '#Medusaceraops1',
																																		'#Xenoceratops5' : '#Xenoceratops6',
																																			'@Eucentrosauria' : '#Xenoceratops5',
																																				'@Centrosaurini' : '@Eucentrosauria',
																																					'#Xenoceratops2' : '@Centrosaurini',
																																						'#Xenoceratops1' : '#Xenoceratops2',
																																							'Xenoceratops' : '#Xenoceratops1',
																																							'Spinops' : '#Xenoceratops1',
																																						'Coronosaurus' : '#Xenoceratops2',
																																					'#Rubeosaurus2' : '@Centrosaurini',
																																						'#Rubeosaurus1' : '#Rubeosaurus2',
																																							'Rubeosaurus' : '#Rubeosaurus1',
																																							'Styracosaurus' : '#Rubeosaurus1',
																																						'Centrosaurus' : '#Rubeosaurus2',
																																				'#Einiosaurus2' : '@Eucentrosauria',
																																					'#Einiosaurus1' : '#Einiosaurus2',
																																						'Einiosaurus' : '#Einiosaurus1',
																																						'Achelousaurus' : '#Einiosaurus1',
																																					'Pachyrhinosaurus' : '#Einiosaurus2',
																																			'Machairoceratops' : '#Xenoceratops5',
																																		'#Sinoceratops1' : '#Xenoceratops6',
																																			'Sinoceratops' : '#Sinoceratops1',
																																			'Wendiceratops' : '#Sinoceratops1',
																																				
																													'@Chasmosaurinae' : '#Chasmosaurinae1',
																														'#Arrhinoceratops3' : '@Chasmosaurinae',
																															'#Arrhinoceratops2' : '#Arrhinoceratops3',
																																'#Arrhinoceratops1' : '#Arrhinoceratops2',
																																	'Arrhinoceratops' : '#Arrhinoceratops1',
																																	'@Triceratopsini' : '#Arrhinoceratops1',
																																		'Ojoceratops' : '@Triceratopsini',
																																		'Titanoceratops' : '@Triceratopsini',
																																		'Nedoceratops' : '@Triceratopsini',
																																		'Torosaurus' : '@Triceratopsini',
																																		'Triceratops' : '@Triceratopsini',
																																'Anchiceratops' : '#Arrhinoceratops2',
																																'Regaliceratops' : '#Arrhinoceratops2',
																															'#Mojoceratops4' : '#Arrhinoceratops3',
																																'#Mojoceratops3' : '#Mojoceratops4',
																																	'#Mojoceratops2' : '#Mojoceratops3',
																																		'#Mojoceratops1' : '#Mojoceratops2',
																																			'Mojoceratops' : '#Mojoceratops1',
																																			'Chasmosaurus' : '#Mojoceratops1',
																																		'Agujaceatops' : '#Mojoceratops2',
																																	'#Kosmoceratops4' : '#Mojoceratops3',
																																		'#Kosmoceratops3' : '#Kosmoceratops4',
																																			'#Kosmoceratops2' : '#Kosmoceratops3',
																																				'#Kosmoceratops1' : '#Kosmoceratops2',
																																					'Kosmoceratops' : '#Kosmoceratops1',
																																					'Vagaceratops' : '#Kosmoceratops1',
																																				'Spiclypeus' : '#Kosmoceratops2',
																																			'Pentaceratops' : '#Kosmoceratops3',
																																		'Utahceratops' : '#Kosmoceratops4',
																																'Coahuilaceratops' : '#Mojoceratops4',
...
for(var i in tree) { // set up node positions
	...
	if(i != '@Dinosauria'){
		...
		if(siblings == 1) {
			treeWithDetails[i].alottedHeight = treeWithDetails[tree[i]].alottedHeight / 1.5;
		}
